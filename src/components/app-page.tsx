      ...
      <div className="w-full h-full justify-center">
        <div className="h-full flex flex-shrink-0 flex-row-reverse w-full">
          ...
          <div className={clsx("relative w-full h-full", showConversation && "md:block hidden")}>
            ...
            <PromptForm className={clsx("bg-muted/50 border backdrop-blur-xl bg-opacity-70 sm:absolute p-4 bottom-4 sm:left-1/2 sm:transform sm:-translate-x-1/2 lg:w-[50%] sm:w-[70%] w-full rounded-xl ", (showConversation || preview) && "hidden")} id={id} showPrivate={false} />
          </div>
        </div>
      </div>)
  }
